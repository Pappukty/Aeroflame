    ...
    <div class="row">
        <div class="col-sm-8">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Listing of All Purchase Orders </li>
            </ul>
        </div>
        <div class="col-md-4" align="right">
            <a class="btn btn-primary btn-rounded" href="create_order.php">
                <i class="mdi mdi-settings-outline mr-1"></i> Add New Purchase Orders
            </a>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            <?php $select = "SELECT po.*, s.product_name AS supplier_name FROM purchase_order po
        JOIN products s ON po.supplier_id = s.id";
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center justify-content-between w-100">
                                                <div class="d-flex align-items-center">
                                                    <!-- Edit button -->
                                                    <a class="btn btn-sm p-2 btn-primary text-white  edit-board alert-box-trigger waves-effect waves-light kill-drop" href="create_order.php?id=<?php echo $Row->id; ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="header-title">Delete Order </h5>
                    <button type="btn" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" align="center">
                    <h5 class="text-center">Delete Order Details ?</h5>
