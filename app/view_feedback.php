...
<div class="page-header">
    <div class="row">
        <div class="col-sm-8">
            <h3 class="page-title">All Feedback View </h3>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                <li class="breadcrumb-item active">Listing of All Feedback View </li>
            </ul>
        </div>
        <div class="col-md-4" align="right">
            <a class="btn btn-primary btn-rounded" href="create_order.php">
                <i class="mdi mdi-settings-outline mr-1"></i> Add New Feedback View
            </a>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            <?php
                            $technician_id = isset($_GET['technician_id']) ? intval($_GET['technician_id']) : 1; // Example ID
                            // Prepare SQL statement
                            $select = "SELECT id, customer_name, rating, comments, service_date FROM feedback WHERE technician_id = ?";
                            $stmt = $DatabaseCo->dbLink->prepare($select);
                                            ...
                                            <div class="d-flex align-items-center justify-content-between w-100">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <a class="btn btn-sm p-2 btn-primary text-white edit-board alert-box-trigger waves-effect waves-light kill-drop"
                                                        href="create_order.php?id=<?php echo $Row->id; ?>">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <a class="btn btn-sm p-2 btn-danger delete-board alert-box-trigger waves-effect waves-light kill-drop text-white"
                                                        data-modal="delete-board-alert" data-toggle="modal" data-target="#delete-board-alert"
                                                        href="#0" data-id="<?php echo $Row->id; ?>" id="delete-board<?php echo $Row->id; ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="header-title">Delete Feedback </h5>
                    <button type="btn" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" align="center">
                    <h5 class="text-center">Delete Feedback Details ?</h5>
                    <p>Are you sure you want to delete this Order details? All data and attached deals will be lost.</p>
                </div>
                <div class="modal-footer">
                    <input type="hidden" name="form_action" value="DeleteOrder" />
